    ...
    let (kind, data) = match op {
        ...
        BrokerWriteOp::ToolInvocationStarted => (
            ...
            suite_packet_core::AgentStateEventData::ToolInvocationStarted {
                ...
                compact_path: request.compact_path.clone(),
                passthrough_reason: request.passthrough_reason.clone(),
            },
        ),
        BrokerWriteOp::ToolInvocationCompleted => (
            ...
            suite_packet_core::AgentStateEventData::ToolInvocationCompleted {
                ...
                compact_preview: request.compact_preview.clone(),
                request_fingerprint: request.request_fingerprint.clone(),
                ...
                compact_path: request.compact_path.clone(),
                passthrough_reason: request.passthrough_reason.clone(),
                raw_est_tokens: request.raw_est_tokens,
                reduced_est_tokens: request.reduced_est_tokens,
                raw_artifact_handle: request.raw_artifact_handle.clone(),
                raw_artifact_available: request.raw_artifact_available.unwrap_or(false),
                regions: request.regions.clone(),
