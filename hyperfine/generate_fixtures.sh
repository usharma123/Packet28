...
OUT_DIR="$ROOT_DIR/hyperfine/generated"
mkdir -p "$OUT_DIR"
...
gen_sarif() {
  ...
  {
    printf '{"version":"2.1.0","runs":[{"tool":{"driver":{"name":"hyperfine-bench","rules":[{"id":"bench/rule"}]}},"results":[\n'
...
echo "Generating synthetic hyperfine fixtures in $OUT_DIR"
